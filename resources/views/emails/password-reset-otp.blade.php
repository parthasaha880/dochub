@extends('emails.layout', ['title' => 'Password recovery'])

@section('content')
    <p style="margin:0 0 8px;font-size:13px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:#06b6d4;">
        Password recovery
    </p>
    <h1 style="margin:0 0 16px;font-size:24px;line-height:1.3;color:#0e2f45;font-weight:700;">
        Reset your EDAMS password
    </h1>
    ...
    <p style="margin:0 0 22px;font-size:15px;line-height:1.65;color:#475569;">
        ...
        <strong style="color:#0e2f45;">{{ $email }}</strong>.
        Enter this one-time code on the recovery page to continue.
    </p>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 22px;">
        <tr>
            <td style="border-radius:10px;background:#154360;">
                <a href="{{ $resetUrl }}" style="display:inline-block;padding:12px 22px;color:#ffffff;text-decoration:none;font-size:14px;font-weight:600;">
